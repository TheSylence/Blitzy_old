...
namespace Blitzy.Tests.Model
{
	...
	public class CommandItem_Tests : TestBase
	{
		...
		public void CreateTest()
		{
			...
			ExceptionAssert.Throws<ArgumentNullException>( () => CommandItem.Create( null, null, plugin ) );
			ExceptionAssert.Throws<ArgumentNullException>( () => CommandItem.Create( "Test", null, null ) );
		}
	}
}